...
class DatasetCreator:
    ...
    def create(self, filter_func=None, logger=None):
        ...
        # for debug
        #while q.pushednumber() < q.datanumber():
            #print('q.pushed = ', q.pushednumber())
            #sleep(1)
        ...
        # for debug
        #while filteredq.pushednumber() < filteredq.datanumber():
            #print('q.pushed = ', q.pushednumber(), ', q.popped = ', q.poppednumber(), ', filteredq.pushed = ',
            #filteredq.pushednumber(), ', filteredq.popped = ', filteredq.poppednumber())
            #sleep(1)
        ...
        # for debug
        #while filteredq.poppednumber() < filteredq.datanumber():
            #s = ''
            #for wq in writeqs:
                #s += '(' + str(wq.pushednumber()) + ', ' + str(wq.poppednumber()) + ')'
            #print('filteredq.pushed = ', filteredq.pushednumber(), ', filteredq.popped = ', filteredq.poppednumber(),
                    #'writeqs: ' + s)
            #sleep(1)
